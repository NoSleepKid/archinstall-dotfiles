...
```bash
yay -S archinstall-dotfiles
```
This uses the [yay](https://github.com/Jguer/yay) package manager to install the package.
...
archinstall-dotfiles
```
This executes the installer so you can install customized Arch on your computer!
